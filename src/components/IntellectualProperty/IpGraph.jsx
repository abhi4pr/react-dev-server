...
const IpGraph = () => {
  ...
  const followersChartY = async () => {
    ...
    axios
      .post(`http://34.93.221.166:3000/api/dataforgraph`, {
  ...
  const saveStats = async (e) => {
    e.preventDefault();
    axios.post(`http://34.93.221.166:3000/api/ip_stats_post`, {
      ip_id: id,
  ...
  const saveIpPageResponsiblity = async (e) => {
    e.preventDefault();
    axios.put(`http://34.93.221.166:3000/api/ipregiupdatenew`, {
      id: id,
