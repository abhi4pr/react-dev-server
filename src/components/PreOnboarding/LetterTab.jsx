      ...
      <div className="letterBoard">
        <div className="thm_textbx">
          {allUserData.offer_later_status ? (
            ...
            <p>
              Hello, {allUserData.user_name}, Welcome to Creativefuel - The home
              to the most vibrant & talented individuals! We're to have you join
              our team of Meme Enthusiasts & Coffee Addicts as a{" "}
              {allUserData.designation_name}! We believe that your experience &
              skills will be a great asset to our organisation. Congratulations
              on your new role, and cheers to a journey full of excitement,
              growth & achievement!
            </p>
          )}
        </div>
