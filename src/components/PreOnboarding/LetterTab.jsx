  ...
  return (
    <>
      <div className="dis-none">
        <body id="element-to-print" style={{ color: "black", background: "white" }}>
          <br />
          <header className="header-letter">
            <img
              src={logo} alt="Creativefuel Logo" width={70} height={70}
            />
          ...
          <article>
            ...
            <section>
              ...
              <p>
                Welcome to the squad! We are all here because someone,
              ...
              <div>
                <p className="bold" >Position: {allUserData?.designation_name}</p >
              ...
              <footer className="footer-letter " style={{ pageBreakAfter: "auto" }}>
            ...
            Creative <span>fuel</span>
              ...
              <div>
                ...
                <div>
                  ...
                  <footer className="footer-letter " style={{pageBreakAfter: "always"}}>
            <p className="bold">CREATIVEFUEL PRIVATE LIMITED</p>
            <p className="bold">
              Registered Office: - 105, Gravity Mall, Vijay Nagar Indore (M.P)
              452010, India
