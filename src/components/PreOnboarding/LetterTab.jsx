    ...
    <>
      ...
      <div className="letterBoard">
        <div className="thm_textbx">
          <p>
            Hello {allUserData.user_name}, Welcome to Creativefuel - The home to
            the most vibrant & talented individuals! We're to have you join our
            team of Meme Enthusiasts & Coffee Addicts as a{" "}
            {allUserData.designation_name}! We believe that your experience &
            skills will be a great asset to our organisation. Congratulations on
            your new role, and cheers to a journey full of excitement, growth &
            achievement!
            ...
            >
              ...
              <article>
                ...
                <section>
                  ...
                  <div>
                    ...
                    <p>
                      We are pleased to extend this offer letter to you to join
                      Creativefuel, a leading marketing agency that thrives on
                      innovation, creativity, and collaboration. After a
                      thorough assessment of your skills and qualifications, we
                      are confident that you are the perfect fit for our team.
                    </p>{" "}
                    <br />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>
                      Your remuneration will have a fixed component of INR{" "}
                      {allUserData?.ctc} Lacs per annum (CTC), paid monthly, and
                      a detailed breakdown of your remuneration can be found in
                      [Annexure-A].
                    </p>
                  </div>{" "}
                  <br />
                  <div>
                    <p className="bold">2)Acceptance:</p>
                    <p>
                      To accept this offer, please sign and return a copy of
                      this letter within 48 hours. You can scan and email it to,
                      onboarding@creativefuel.io CC: fahbir@creativefuel.io or
                      just reply back if I accept the offer. We are excited
                      about the prospect of having you onboard and look forward
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      employment relationship with a notice period of 7 days.
                      This period is intended to allow both you and Creativefuel
                      to assess the mutual fit and alignment of expectations.
                    </p>
                  </div>{" "}
                  <br />
                  <div>
                    <p className="bold">4)Performance Review:</p>
                    <p>
                      At the end of the probation period, your performance will
                      be reviewed. If your performance aligns with our
                      expectations and you are comfortable with the work
                      environment, the probationary status will be lifted.
                    </p>
                  </div>{" "}
                  <br />
                  <div>
                    ...
                    <div>
                      <p>
                        ...
                        attendance and leave policy. Uninformed or unapproved
                        absence from work for a continuous period of 5 days or
                        beyond the period of approved leave, without prior
                        approval of the reporting manager shall result in
                        automatic termination of your employment without any
                      ...
                      <p>
                        ...
                        letter and in other physical or digital documents
                        provided to you pursuant to your signing of this letter.
                        The Company may also terminate you with immediate effect
                        for any dishonest and malicious practices, poor
                        attendance, violation of company policies, involvement
                        in criminal act or non- performance for a prolonged
                        period.
                      </p>{" "}
                      <br />
                      <footer
                      ...
                      <p>
                        C) In case of termination, the company, at its sole
                        discretion, will recover such amount, as the case may
                        be, in lieu of notice period against the full and final
                        settlement upon your separation. In such a case, the
                        company will also not be liable to pay you any pending
                        salary. Furthermore, the Company is at liberty to
                        recover any amount in relation to the performance bonus
                        and sign-on bonus, if any, earned by you, in case your
                        employment relationship gets terminated before
                        completion of one year upon joining.
                      </p>{" "}
                      <br />
                      <p>
                        D) You are required to indemnify and keep indemnifying
                        the Company against all claims, damages, losses etc.,
                        which the Company might suffer, on account of any breach
                        by you of any of the terms of your employment or the
                        terms of any policy of the Company. The Company shall,
                        in addition to any other remedies available by law, be
                        entitled to an injunction restraining you from breaching
                        or otherwise violating any terms of your employment.
                      </p>
                      <p>
                        You shall be bound by all policies and procedures of the
                        Company, which may change from time to time. The
                        management of the Company reserves the right to amend
                        and update the policies and procedures of the Company.
                      </p>{" "}
                      <br />
                    </div>
                  </div>
                  <div>
                    <p className="bold">6)Reimbursement for Expenses:</p>
                    <p>
                      You will be reimbursed for reasonable expenses incurred by
                      you in performance of your duties, according to the
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      work for a continuous period of 3 days or beyond the
                  ...
                  <div>
                    ...
                    <p>
                      You shall be bound by all policies and procedures of the
                      Company, which may change from time to time. The
                      management of the Company reserves the right to amend and
                      update the policies and procedures of the Company.
                    </p>{" "}
                    <br />
                  </div>
                </section>
                ...
                <div>
                  <div>
                    <p>
                      Get ready to embark on a marketing adventure where every
                      day brings a new challenge, a fresh idea, and a funny
                      meme.
                    </p>

                    <p>
                      We eagerly await your decision and the opportunity to work
                      alongside you in pursuit of excellence and innovation.
                      Your acceptance of this offer would mark the beginning of
                      an exciting chapter with Creativefuel.
                    </p>
                  </div>{" "}
                  <br />
                  <div>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      conditions of employment with Creativefuel Private Limited
                      as stated hereinafter. I confirm that I am not breaching
                      any terms or provisions of any prior agreement or
                      arrangement by accepting this offer.
                    </p>
                    <br />
                    <br />
                    <p className="bold">
