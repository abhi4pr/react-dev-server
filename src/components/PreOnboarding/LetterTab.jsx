...
//         </header>
//         <article>
//           <p>Date {allUserData?.joining_date}
//           </p>
//           <section>
//             <p>
//               To,<br />
//               {allUserData?.user_name}<br />
...
//             <div>
//               <p>Dear {allUserData?.user_name},</p>
//               <p>
...
//             </div>
//             <div>
//               <h5>Position: {allUserData?.designation_name}
//               </h5>
//               <h5>Reports to: {allUserData?.Report_L1N}
//               </h5>
//               <h5>Start Date: {allUserData?.joining_date}
//               </h5>
...
//               <p>
//                 Your remuneration will have a fixed component of INR {allUserData?.ctc} Lacs
...
//               <p>
//                 {allUserData?.user_name}<br />
//                   {allUserData?.permanent_address}<br/>
//                   Date {allUserData?.joining_date}
//               </p>
//             </div>
//             <div>
//               <h5>Name: - {allUserData?.user_name}
//               </h5>
//               <h5>Designation: - {allUserData?.designation_name}
//               </h5>
//               <h5>D.O.J: - {allUserData?.joining_date}
//               </h5>
//             </div>
//           </div>
//         </article>
