...
const PocDetails = ({ SingleAccount, SingleAccountLoading }) => {
    const [accountId, setAccountId] = useState(null);

    const { data: PocData, isLoading: PocLoading, error: PocError } = useGetSinglePOCQuery(accountId);

    useEffect(() => {
        if (!SingleAccountLoading) {


            setAccountId(SingleAccount?.account_id + '?_id=false');
        }
    }, [SingleAccount])
    return (
        <div className="pocdetails">
            <h2 className='mb-4' style={{ color: "var(--medium)" }}>POC</h2>
                        ...
                        <div className="card w-100">
                            ...
                            <div className="card-body">
                                <div className="account-detail">
                                    ...
                                    <div className="detail-view">
                                        <div className='details'>
                                            Aternate contact Number: <span>{poc.alternative_contact_no}</span>
                                        </div>
