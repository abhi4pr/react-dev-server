...
export const ViewAccountTypeColumns = [
  ...
  { key: "action", name: "Actions", renderRowCell: (row) => <button className="icon-1" onClick={() => alert(row._id)} ><i className="bi bi-pencil" /></button>, width: 100, sortable: true, showCol: true },
