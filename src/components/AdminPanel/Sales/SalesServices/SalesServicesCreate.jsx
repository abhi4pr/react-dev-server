...
import { useAddSaleServiceMutation } from "../../../../components/Store/API/Sales/SalesServiceApi"
...
const SalesServicesCreate = () => {
  ...
  console.log(amount, servicename, postType);
  const PostTypeData = [
    "Story",
    "Post",
    "Both",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await createSaleService(payload).unwrap();
