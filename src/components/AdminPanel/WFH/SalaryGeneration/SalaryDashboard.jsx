...
const SalaryDashboard = () => {
  ...
  useEffect(() => {
    axios
      .post("http://34.93.221.166:3000/api/get_salary_count_by_dept_year", {
        dept: id,
      })
      .then((res) => {
  ...
  useEffect(() => {
    axios.get(" http://34.93.221.166:3000/api/get_total_salary").then((res) => {
  ...
  const getAttendanceData = () => {
    axios
      .post("http://34.93.221.166:3000/api/get_salary_by_filter", {
        dept: id,
      })
      .then((res) => {
        const data = res.data.data;
