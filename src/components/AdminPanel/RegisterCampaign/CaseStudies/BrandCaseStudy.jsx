    ...
    const renderFileIcon = (fileType, src, detail) => {
        switch (fileType) {
            case "pdf":
                ...
                return (
                    <div style={{ position: "relative", width: "45%", height: "auto" }}> {/* Adjust the height as needed */}
                    <iframe
            ...
            case "mp4":
             ...
             return   <video className="mt-5" controls width="45%" height="auto">
                                    ...
                                    {detail.fileType === "jpg" ||
                                        ...
                                        images[index] && (
                                            <img
                                                ...
                                                style={{ width: "45%", height: "auto", border: "none", overflow: "hidden" }}
                                        ...
                                        >
                                            {renderFileIcon(detail.fileType, URL.createObjectURL(images[index]), detail)}
                                        </div>
                                    )}
                                </div>
                                <div className="col summary_box brand_img_box col140">
